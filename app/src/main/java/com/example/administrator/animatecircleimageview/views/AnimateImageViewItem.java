 ...
 * Created by CeuiLiSA.
 */
public class AnimateImageViewItem extends CircleImageView {
    private Spring springX, springY;
    private SimpleSpringListener followerListenerX, followerListenerY; // 此为跟踪的回调，当前面一个view移动的时候，此为后面的view，需要更新endValue

    public AnimateImageViewItem(Context context) {
        this(context, null);
    }

    public AnimateImageViewItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AnimateImageViewItem(Context context, AttributeSet attrs, int defStyleAttr) {
